...
class QueenProblems4 extends StatefulWidget {
  const QueenProblems4({super.key});

  @override
  State<QueenProblems4> createState() => _QueenProblems4State();
}

class _QueenProblems4State extends State<QueenProblems4> {

  List<List<dynamic?>> aliveList = List.generate(4, (_) => List.filled(4, null));
  List<List<dynamic>> colorList = List.generate(4, (_) => List.filled(4, null));
  List<List<int>> arr = List.generate(4, (_) => List.filled(4, 0));
          ...
          Column(
            ...
            children: [
                          ...
                          child: Container(
                            ...
                            child: GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  int row = (index ~/ 4); //(MatchView.whiteView)?7-(index ~/ 4):(index ~/ 4);
                                  int dsRow = (index ~/ 4);
                                  int column = index % 4;
              ...
              Padding(
                ...
                child: Text((isSolved==true && disMsg==true)?'4-Queens Problem Solved':(disMsg==true)?'4-Queens Problem Not Solved':'', style: TextStyle(color: Colors.white, fontSize: 20),),
              ),
            ],
          ),
          AnimatedPositioned(
